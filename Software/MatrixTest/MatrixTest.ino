...
void setup() {
  ...
  //  // draw a blue circle
  //  for (int i = 0; i < 20; i++) {
  //    matrix.drawCircle(10, 10, i-1, matrix.Color333(0, 0, 0));
  //    matrix.drawCircle(10, 10, i, matrix.Color333(0, 0, 7));
  //
  //    delay(300);
  //  }
...
void loop() {
  ...
  for (int i = 0; i < 20; i++) {
    matrix.drawCircle(10, 10, i - 1, matrix.Color333(0, 0, 0));
    matrix.drawCircle(10, 10, i, matrix.Color888((10 * i) % 256, (20 * i) % 256, (30 * i) % 256));
    delay(50);
  }
